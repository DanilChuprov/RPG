...
public class Realm {
    ...
    private static Personages player = null;
    ...
    private static void command(String string) throws IOException {
        if (player == null) {
            player = new Hero(string,
                    ...
                    0,
                    0);
            System.out.println(String.format("Спасти наш мир от инфоцыган и шарлатанов вызвался %s! Да будет его броня крепка и вера непоколебима!", player.getName()));
            printNavigation();
        }
        switch (string) {
            case "1": {
    ...
    private static Personages createMonster() {
        //Рандомайзер
